...
/// - Сохранение номера телефона в профиле;
...
/// и синхронизирует актуальный номер телефона в профиле пользователя.
final class EditPhoneViewModel: ObservableObject, EditPhoneViewModelProtocol {
