...
final class CheckoutViewModel: ObservableObject, CheckoutViewModelProtocol {
    ...
    func placeOrder() async throws {
        ...
        let _ = try await ordersRepository.createOrderFromCheckout(
    ...
    private func validateBeforePlacing() throws {
        ...
        if deliveryMethod == .delivery {
            ...
            guard hasAddress && hasPhone else {
                throw CheckoutError.missingRequiredFields
            }
        }
    }
